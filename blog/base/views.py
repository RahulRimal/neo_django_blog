...
from base.helpers import get_formatted_date
...
def home(request):
    ...
    for post in blogs:
        ...
        post.posted_on = get_formatted_date(post.posted_on)
...
def post(request, post_id):
    ...
    blog_info = BlogPost.objects.get(pk= post_id)


    blog_info.posted_on = get_formatted_date(blog_info.posted_on)

    return render(request, 'post.html', {'blog_info': blog_info})
